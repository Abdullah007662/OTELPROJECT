...
namespace OteLProjectDataAccessLayer.Migrations
{
    ...
    [Migration("20250103182816_mig_add_Users_gender")]
    partial class mig_add_Users_gender
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Room", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Service", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Staff", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Subscribe", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Testimonial", b =>
                {
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("OteLProjectEntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("OteLProjectEntityLayer.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.AppUser", b =>
                {
                    b.HasOne("OteLProjectEntityLayer.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("OteLProjectEntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("OteLProjectEntityLayer.Concrete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
